...
namespace DrinkDotCom.Areas.Dashboard.Controllers
{
    public class RolesController : BaseController
    {
        ...
        public RolesController(DrinkDotComUserManager userManager, DrinkDotComRoleManager roleManager, DrinkDotComSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> RoleUsers(string roleID, int? pageNo)
        {
            ...
            if (role != null)
            {
                ...
                //model.RoleUsers = new List<DrinkDotComUser>();
